...
웹툰의 대표적인 수익 모델은 PPS , 부분유료화(쿠키 등 화폐)입니다. 즉, 웹툰 조회수, 시청자들의 참여도, 광고 노출수, 쿠키 결제량은 수익에 비례하며 이는 웹툰을 운영하는 입장에서 독자들의 관심도를 높히고 작품을 꾸준히 보고 있는지 관리할 수 있도록 모니터링 및 분석이 필요할 것입니다. 제가 평소에 즐겨보는 '무직백수 계백순' 이라는 작품을 하나의 프로덕트로 보고 독자들의 댓글 데이터를 활용하여 핵심성과지표와 EDA를 통해 얻은 인사이트를 정리해보려고합니다.


## 데이터 수집 및 전처리

> 파이썬 (셀레니움)을 이용해서 데이터를 수집했습니다.
...
*  즉, '닉네임(id***)'이 같은 경우 동일 유저로 판단했습니다.
...
> #### 프로모션 세워보기
> 오전/낮 시간대의 더 많은 UV 확보하기 위해 **'등교/출근, 점심 시간대에 맞춘 n분 무료보기 및 쿠키 조조할인 혜택'** 프로모션을 진행하려고 하는데요! 이름하여 **출근/밥친구 이벤트** 입니다!


#### 🤔 프로모션 진행 이유
* 상대적으로 비어있는 오전, 낮시간대의 AU를 확보하려고 합니다.
* 다양한 라이프 스타일이 존재 하듯, 특정시간대에만 웹툰을 감상하는 독자들이 있었습니다.
* 가령, 아례 '즈마' 라는 독자는 오전에만 웹툰을 감상(96%)하는 독자입니다.

![image](https://github.com/user-attachments/assets/467615fc-5648-4476-96ef-d62713b0b59c)

#### ✔️ 기대효과
- 이를 통해, 해당 웹툰을 아직 보지 않은 신규 독자 유입 및 오전/점심 독자의 쿠키 결제 전환율 기대할 수 있습니다.
...
* 수집한 데이터의 기간에 따라 8개월 동안의 예상 LTV를 산출
